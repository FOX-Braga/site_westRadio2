<?php
$page_title = "Termos de Uso - 96 News";
...
<div class="container" style="max-width: 800px; margin-bottom: 80px; min-height: 50vh;">
    ...
    <div style="font-size: 1.1rem; line-height: 1.8; color: var(--color-text); font-family: var(--font-family);">
        <p style="margin-bottom: 25px;">Ao acessar o portal <strong>96 News</strong>, você concorda em cumprir e estar vinculado aos seguintes Termos de Uso. Leia atentamente as condições abaixo antes de utilizar os nossos serviços.</p>
        ...
        <p style="margin-bottom: 25px;">O 96 News poderá revisar ou atualizar estes Termos de Uso a qualquer momento, visando se adequar a novas legislações ou mudanças estruturais no portal. Recomendamos que os usuários visitem esta página periodicamente.</p>
        
        <div style="background: var(--color-surface); padding: 30px; border-radius: 8px; border: 1px solid var(--color-border); margin-top: 50px;">
            <p style="margin-bottom: 0; font-size: 1rem;">Ao continuar utilizando nosso portal, você concorda formalmente com os Termos expostos acima. Para falar conosco sobre questões legais, envie um e-mail para <a href="mailto:juridico@96news.com" style="color: var(--color-primary); font-weight: bold;">juridico@96news.com</a>.</p>
        </div>
    </div>
</div>
